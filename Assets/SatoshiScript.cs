...
public class SatoshiScript : MonoBehaviour {
    ...
    void Start () {
        cameraFollowObject = this.gameObject;
    }
    ...
    void FixedUpdate () {
        ...
        careraTransform.LookAt (cameraFollowObject.GetComponent<Transform> ());
        // (-10, 10, -10) หมายถึงระยะห่างของกล้องและ GameObject
        careraTransform.position = cameraFollowObject.GetComponent<Transform> ().position + new Vector3 (-10, 10, -10);
    }
